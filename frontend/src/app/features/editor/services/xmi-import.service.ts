...
export class XmiImportService {
  ...
  preview(file: File): Observable<XmiImportResponse> {
    ...
    return this.http.post<XmiImportResponse>(`${API_BASE_URL}/import/xmi/preview`, form);
  }
  ...
  apply(diagramId: string, baseVersion: number, file: File): Observable<XmiImportResponse> {
    ...
    return this.http.post<XmiImportResponse>(`${API_BASE_URL}/import/xmi/apply`, form, { params });
  }
}
